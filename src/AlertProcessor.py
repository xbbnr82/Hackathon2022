            ...
            for alertProc in resAlertDetialsList:
                ...
                if alertProc[0] == g_percentageSizeAlert and alertProc[3] == "1":
                    ...
                    if percentageOfSizeDiff > percentageSizeLimit or percentageOfSizeDiff < -percentageSizeLimit:
                        alertDesc = "The File {0} size {1}KB with percentage {2} is outside the limit of +/-{3} Percentage of last record.".format(fetchedResult[0], sizesList[0], percentageOfSizeDiff, percentageSizeLimit)
                        print (alertDesc)
